...
The [`Xml` decorators](./src/index.ts) map TypeScript classes to XML elements.
See the [serialization guide](../../docs/docs-dev/serialization/xml.md) for
an explanation of how these mappings are used across the project.
...
- [XML serialization mapping](../../docs/docs-dev/serialization/xml.md)
