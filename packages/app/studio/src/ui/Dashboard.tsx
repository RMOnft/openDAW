    ...
    <div className={className}>
      <article role="main">
        ...
        <p style={{ margin: "1em 0 0 0" }}>
          This is an <span className="highlight">early prototype</span> giving
          you an early glimpse of the development state.
        </p>
          ...
          <div>
            ...
            <div className="starters">
              {[
                ...
                {
                  name: "Shafted",
                  click: () => service.loadTemplate("Shafted"),
                },
                {
                  name: "Seek Deeper",
                  click: () => service.loadTemplate("SeekDeeper"),
                },
                { name: "Fatso", click: () => service.loadTemplate("Fatso") },
                {
                  name: "Bury Me",
                  click: () => service.loadTemplate("BuryMe"),
                },
                {
                ...
                {
                  name: "Liquid",
                  click: () => service.loadTemplate("BMX_LiquidDrums"),
                },
                {
                  name: "Release",
                  click: () => service.loadTemplate("Release"),
                },
                {
                  name: "Dub Techno",
                  click: () => service.loadTemplate("Dub-Techno"),
                },
                ...
                >
                  <img
                    src={`viscious-speed/abstract-${String(index).padStart(3, "0")}.svg`}
                    alt=""
                  />
                  <label>{name}</label>
                </div>
        ...
        <p style={{ marginTop: "1.5em", fontSize: "0.625em" }}>
          Last built was <span style={{ color: Colors.green }}>{time}</span>.
          Join our{" "}
          <a
            href="https://discord.opendaw.studio"
            target="discord"
          ...
          · <LocalLink href="/imprint">imprint</LocalLink> · Built with ❤️
        </p>
      </article>
    </div>
  );
