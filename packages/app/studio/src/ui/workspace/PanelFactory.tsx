...
/**
 * Creates a mapping from {@link PanelType} to the React component that renders
 * that panel. The returned factory is used by the workspace to instantiate
 * panel contents on demand.
 */
export const createPanelFactory = (
