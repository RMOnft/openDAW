...
const Icons = [
  ...
  IconSymbol.Waveform,
  IconSymbol.Flask,
  IconSymbol.BassGuitar,
  IconSymbol.Guitar,
  IconSymbol.DrumSet,
  IconSymbol.Microphone,
  IconSymbol.Saxophone,
  IconSymbol.Heart,
  IconSymbol.Robot,
] as const;
...
export const showNewAudioBusOrAuxDialog = (
  suggestName: string,
    ...
    >
      <div
        style={{
          padding: "1em 0",
          display: "grid",
          gridTemplateRows: "auto auto 0px auto auto",
          rowGap: "4px",
        }}
        role="form"
        aria-label="Create Aux Bus"
      >
        <span>Icon</span>
        <RadioGroup
          lifecycle={lifecycle}
